...
public:
	...
	virtual TBOOL        WasDown(TINT doodad) const                    = 0;
	virtual TWCHAR*      TranslateDoodadToCharacter(TINT doodad) const = 0;
	// FIXME: add other virtual methods of this class...
	virtual TINT ProcessVirtualButtons(TEmitter<TInputInterface, TInputInterface::InputEvent>& emitter, TFLOAT flt);
