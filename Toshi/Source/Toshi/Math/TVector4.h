...
public:
	TVector4() = default;
	TVector4(TFLOAT x, TFLOAT y, TFLOAT z, TFLOAT w)
	{
		TVector4::x = x;
		TVector4::y = y;
		TVector4::z = z;
	...
	void Divide(const TVector4& vec1, const TVector4& vec2) { Set(vec1 / vec2); }
	...
	void Multiply(const TVector4& vec1, const TVector4& vec2) { Set(vec1 * vec2); }
	...
	TFLOAT*         AsArray() { return reinterpret_cast<TFLOAT*>(this); }
	const TFLOAT*   AsArray() const { return reinterpret_cast<const TFLOAT*>(this); }
	...
	TVector4(const DirectX::XMFLOAT4& vector) { *(DirectX::XMFLOAT4*)this = vector; }

	TVector4(const DirectX::XMVECTOR& vector) { *(DirectX::XMVECTOR*)this = vector; }

	const DirectX::XMVECTOR& XMM() const { return *(DirectX::XMVECTOR*)this; }
