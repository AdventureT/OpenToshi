...
public:
	...
	void Set(TFLOAT x, TFLOAT y, TFLOAT z)
	{
		TVector3::x = x;
		TVector3::y = y;
		TVector3::z = z;
	...
	void Lerp(const TVector3& finish, TFLOAT t) { Lerp(*this, finish, t); }
	void Lerp(const TVector3& start, const TVector3& finish, TFLOAT t)
	{
	...
	void Add(const TVector3& a, const TVector3& b) { Set(a + b); }
	...
	void Divide(const TVector3& vec1, const TVector3& vec2) { Set(vec1 / vec2); }
	...
	void Multiply(const TVector3& vec1, const TVector3& vec2) { Set(vec1 * vec2); }
