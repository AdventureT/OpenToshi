...
public:
	...
	void Add(const TVector2& a, const TVector2& b) { Set(a + b); }
	...
	void Divide(const TVector2& vec1, const TVector2& vec2) { Set(vec1 / vec2); }
	...
	void Multiply(const TVector2& vec1, const TVector2& vec2) { Set(vec1 * vec2); }
