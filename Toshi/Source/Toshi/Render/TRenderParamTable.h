...
public:
	static constexpr const TCHAR* s_V4ParamNames[] = { "",
		                                               "tambcolour",
		                                               "tdirlight0",
		                                               "tdirlight0col",
		                                               "tdirlight1",
	...
	static constexpr const TCHAR* s_M44ParamNames[] = { "", "tmodelview", "tmodelviewproj", "tmodelworld", "tproj", "{" };
...
public:
	...
	TINT FindParameterV4Handle(const TCHAR* paramName) { return m_V4Table.GetStringID(paramName); }

	TINT FindParameterM44Handle(const TCHAR* paramName) { return m_M44Table.GetStringID(paramName); }
...
private:
	...
	TINT         m_iNumV4Params;     // 0x24
	TINT         m_iNumMatrixParams; // 0x28
	TINT         m_iNumTexParams;    // 0x2C
};
