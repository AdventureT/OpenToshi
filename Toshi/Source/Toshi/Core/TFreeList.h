...
public:                                                           \
	...
	{                                                             \
		return ms_oFreeList.New(sizeof(CLASS_NAME));              \
	}                                                             \
...
#define TDEFINE_FREELIST_ALLOCATOR(CLASS_NAME) Toshi::TFreeList CLASS_NAME::ms_oFreeList = Toshi::TFreeList(sizeof(CLASS_NAME), 0, 8, #CLASS_NAME);

#define TDEFINE_FREELIST_ALLOCATOR1(CLASS_NAME, GROW_SIZE) Toshi::TFreeList CLASS_NAME::ms_oFreeList = Toshi::TFreeList(sizeof(CLASS_NAME), 0, GROW_SIZE, #CLASS_NAME);
