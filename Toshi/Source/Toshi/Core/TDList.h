...
public:
	...
	void RemoveHead()
	{
		if (!IsEmpty()) m_Root.Next()->Remove();
	}
	void RemoveTail()
	{
		if (!IsEmpty()) m_Root.Prev()->Remove();
	}
...
public:
	...
	public:
		...
		template <typename T> T* operator*() { return static_cast<T*>(this); }
...
template <class T> class TPriList : public TGenericPriList
{
public:
	TPriList() {}
...
template <class T> class TDList : public TGenericDList
{
public:
	TDList() {}
