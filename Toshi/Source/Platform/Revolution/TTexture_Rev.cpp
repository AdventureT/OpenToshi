...
{
	TUINT8 bitsPerTexel = GetBitsPerTexel(m_texFmt);
	switch (bitsPerTexel)
	{
		case 0x4: Swizzle4Bit(); return;
		case 0x8: Swizzle8Bit(); return;
		case 0x10: Swizzle16Bit(); return;
		case 0x20: Swizzle32Bit(); return;
		default: return;
	}
}
