...
TBOOL TInputDXDeviceController::IsDirectInputController(LPCDIDEVICEINSTANCEA a_poDeviceInstance)
{
	...
	if (TStringManager::String8FindString(fmtStr, (TCHAR*)"09cc054c-0000-0000-0000-504944564944") == TNULL && TStringManager::String8FindString(fmtStr, (TCHAR*)"05C4054C-0000-0000-0000-504944564944") == TNULL &&
	    TStringManager::String8FindString(fmtStr, (TCHAR*)"00050925-0000-0000-0000-504944564944") == TNULL && TStringManager::String8FindString(fmtStr, (TCHAR*)"0268054C-0000-0000-0000-504944564944") == TNULL &&
