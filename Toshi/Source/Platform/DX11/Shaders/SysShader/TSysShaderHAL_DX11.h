...
public:
	...
	ID3D11PixelShader* GetPixelShaderNoTex() const { return m_pPixelShaderNoTex; }

	ID3D11PixelShader* GetPixelShaderTexture() const { return m_pPixelShaderTexture; }

	ID3D11PixelShader* GetPixelShaderAlphaTexture() const { return m_pPixelShaderAlphaTexture; }
