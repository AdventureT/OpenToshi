...
public:
	...
	ID3D11VertexShader* GetVertexShader() const { return m_pVShader; }

	ID3D11PixelShader* GetPixelBasicShader() const { return m_pPShaderBasic; }

	ID3D11PixelShader* GetPixelImageShader() const { return m_pPShaderImage; }
