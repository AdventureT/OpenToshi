...
class TMSWindow : public TGenericClassDerived<TMSWindow, TObject, "TMSWindow", TMAKEVERSION(1, 0), TFALSE>
{
public:
...
public:
	...
	TBOOL IsDestroyed() const { return m_IsDestroyed; }

	TBOOL IsPopup() const { return m_IsPopup; }

	TBOOL IsWindowed() const { return m_IsWindowed; }
