...
void ACamera::RotateAroundAxis(const Toshi::TVector4& a_vAxis, TFLOAT rotation)
{
...
void ACamera::RotateAroundRight(TFLOAT rotation, TFLOAT a_fVal)
{
	...
	TFLOAT   fDotProduct = vAxis.DotProduct(sm_vWorldUp);
	TFLOAT   fVal        = 1.0f - a_fVal;
