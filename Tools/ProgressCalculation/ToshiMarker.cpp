...
public:
  virtual void run(const MatchFinder::MatchResult &Result) {
    ...
    if (const CXXMethodDecl *md =
      ...
      if (md->isThisDeclarationADefinition() && !md->isDefaulted() && md->isDefined() && (srcMgr.getFilename(location).contains("OpenBarnyard") || srcMgr.getFilename(location).contains("OpenToshi"))) {
