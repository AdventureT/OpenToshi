...
def main():
    cpp_files = []
    cpp_files.extend(find_cpp_files('C:\\Users\\Leon\\source\\repos\\OpenToshi\\OpenBlob\\Source'))
    cpp_files.extend(find_cpp_files('C:\\Users\\Leon\\source\\repos\\OpenToshi\\Shared\\Source'))
    cpp_files.extend(find_cpp_files('C:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Source'))
        ...
        try:
            if 'Profiler' not in file:
                ...
                subprocess.call([
                    ...
                    file,
                    '--',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\OpenBlob\\Source',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Source',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Shared\\Source',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\fmod\\include',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\glew\\include',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\glm\\include',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\libogg\\include',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\libtheora\\include',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\sdl2\\include',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\spdlog\\include',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\stb',
                    r'-IC:\\Users\\Leon\\source\\repos\\OpenToshi\\Toshi\\Vendor\\theoraplay\\include',
                    '--language=c++',
                    '-includeToshi/Source/ToshiPCH.h',
                    '-std=c++20',
                    '-DTOSHI_RELEASE',
                    '-DTOSHI_SKU_WINDOWS',
                    '-DTOSHI_RENDERER_DX11',
                    '-DTOSHI_USER_ENGINE',
                    '-m32',
                    '-ferror-limit=0',
                    '-Wno-everything'
